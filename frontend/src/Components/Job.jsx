...
const Job = ({ job }) => {
    ...
    const daysAgoFunction = (mongodbTime) => {
        ...
        return Math.floor(timeDifference / (1000 * 60 * 60 * 24)); // Convert time difference to days
    }
...
Job.propTypes = {
    job: PropTypes.shape({
        ...
        createdAt: PropTypes.string.isRequired // Assuming createdAt is a string date
    }).isRequired
};
